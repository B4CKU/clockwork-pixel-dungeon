...
public class ItemSpriteSheet {
	...
	public static final int WRENCH          = WEP_TIER1+1;
	...
	public static final int ARTIFACT_BAG        = ARTIFACTS+23;
	static{
		...
		assignItemRect(ARTIFACT_BAG,        15, 16);
	}
